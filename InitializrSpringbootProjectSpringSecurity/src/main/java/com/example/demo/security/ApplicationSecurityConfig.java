...
//                .and()
                ...
                .formLogin()
                    ...
                    .usernameParameter("username")//serve para determinar o nome do parametro da página dentro do form
                ...
                .logout()
                    .logoutUrl("/logout")
                    .logoutRequestMatcher(new AntPathRequestMatcher("/logout","GET"))//para crsf ativo deve utilizar o post
